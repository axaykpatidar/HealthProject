            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <center><h3>confirm claim request</h3><br><br>
                            <div>
                                <%
                                int cId = Integer.parseInt(request.getParameter("cId"));
                                %>
                                <form class="form" action="../payment.jsp?op=claimConfirmation&cId=<%=cId%>" method="post">
                                    Amount to be paid : <input type="number" name="amount"><br><br>
