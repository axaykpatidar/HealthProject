<%-- 
    Document   : confirmedClaims
    Created on : 13 May, 2020, 8:16:50 AM
    Author     : AKSHAY
--%>
            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
               ...
               <thead>
                                    ...
                                    <%  int i=0;          
                                        ...
                                        ArrayList<Claim> confirmedClaims = cd.getClaimsByStatus("confirmed");
                                        for (Claim claim : confirmedClaims) { 
                                             i++;
                                    %>
                                    <tbody>
                                    <td><%=i%></td>
