        ...
        <div class="main-content">
            ...
            <div class="container-fluid content-top-gap">
                ...
                <div class="data-tables">
                     <div class="col-lg-12">
                            <center><h3>If Policy Holder is hospitalized then Fill Other Details :</h3></center><br>
                            <div>
                                <%
                                String email =  request.getParameter("email");
                                %>
                                <form class="form" action="claimDocs.jsp" method="post">
                                    ...
                                    <input type="number" name="billAmount" class="form-control" placeholder="Total Bill Amount"><br>
                                    <input type="submit" name="submit" value="Next" class="form-control btn-outline-info">
                                </form>
                            </div>
                        </div>
