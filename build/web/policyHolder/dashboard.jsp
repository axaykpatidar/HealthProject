...
<html lang="en">
    ...
    <i class="fa-fa-user"><title>User Dashboard</title></i>
...
<body><link rel="stylesheet" href="assets/css/demobar_w3_4thDec2019.css">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        <a href="../login.jsp" ga-on="click" ga-event-category="Collective Admin Panel Template" ga-event-action="view" ga-event-label="Collective Admin Panel - view">
            ...
            <div class="main-content">
                ...
                <div class="container-fluid content-top-gap">
                    ...
                    <div class="welcome-msg pt-3 pb-4">
                        <h1>Hi <span class="text-primary"><%=user.getName()%> </span>, Welcome back</h1>
                    <p>Very detailed & featured User.</p>
                </div>
