...
<html lang="en">
    ...
    <i class="fa-fa-user"><title>Renew Details Page</title></i>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card card_border p-4">
                                <h3 class="card__title position-absolute">More Details </h3><br>
                                <div class="table-responsive">
                                    <h3>Name of Policy Holder : </h3>
                                    <%int j=1;
                                        int pHolderId = (Integer.parseInt(request.getParameter("pId")));
                                        int payAmount = (Integer.parseInt(request.getParameter("payAmount")));
                                        PolicyHolderDao phd = new PolicyHolderDao();
                                        ArrayList<PolicyHolder> phList = phd.getPolicyHolderByPhId(pHolderId);
                                       for (PolicyHolder p : phList) {%>
                                    <h4><%=j++%>. <%=p.getName()%></h4><br>
                                    <% 
                                        }
                                     %>
                                     <a href="../payment.jsp?payAmount=<%=payAmount%>&op=renew&phId=<%=pHolderId%>" class="btn btn-primary">Confirm</a>     
                                        <a href="renew.jsp" class="btn btn-danger">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>  
